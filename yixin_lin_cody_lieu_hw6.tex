...
\begin{center}
	...
	% \begin{center}Figure 4. Reconstructed objects for \texttt{sigma}=0\end{center}
	% \includegraphics[width=.5\textwidth]{0sigma.png}
	% \newpage
	% \begin{center}Figure 5. Reconstructed objects for \texttt{sigma}=1\end{center}
	% \includegraphics[width=.5\textwidth]{1sigma.png}
	% \begin{center}Figure 6. Reconstructed objects for \texttt{sigma}=2\end{center}
	% \includegraphics[width=.5\textwidth]{2sigma.png}
	% \begin{center}Figure 7. Reconstructed objects for \texttt{sigma}=3\end{center}
	% \includegraphics[width=.5\textwidth]{3sigma.png}
	% \newpage
